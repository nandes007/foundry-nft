...
This project i build from <b>Learn Solidity Smart Contract Development | Full 2024 Cyfrin Updraft Course</b> by [Patrick Collins Youtube Channel](https://www.youtube.com/watch?v=-1GB6m39-rM).

This project go through creating 2 different kinds of NFTs.
...
```
git clone https://github.com/nandes007/foundry-nft
cd foundry-nft
forge install
forge build
```
